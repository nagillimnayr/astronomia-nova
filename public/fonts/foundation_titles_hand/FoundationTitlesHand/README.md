...
!["Foundation" set over photo of galaxy in Foundation Titles semibold font](../Foundation_Titles_Hand_name_800px.png?raw=true "Foundation Titles OFL font")
...
![The normal and semibold characters of Foundation Titles font](../Foundation_Titles_Hand_charsets_v0.85.png?raw=true "Foundation Titles character set, Basic Latin coverage")

To download the related OFL font based on the typeface used in Foundation to indicate changes in time (e.g., "17 YEARS AFTER THE STARBRIDGE BOMBING") or location ("DWARF PLANET AETHRA"), visit the <a href="https://github.com/rsperberg/foundation-one" title="Jump to Foundation Titles repo">Foundation One</a> repo on Github.
