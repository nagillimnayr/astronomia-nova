...
const NavBar = () => {
  ...
  return (
    <>
      <header
        className={cn(
          `sticky top-0 z-[99999999] flex h-28 w-screen min-w-full flex-row items-stretch justify-start bg-secondary p-0 text-white`,
          { '-translate-y-[100%]': !isOpen }
        )}
      >
        <div
          className={cn(
            'flex h-full w-screen min-w-full flex-row items-stretch justify-start  py-0 pl-6 pr-36',
            { invisible: !isOpen }
          )}
        >
