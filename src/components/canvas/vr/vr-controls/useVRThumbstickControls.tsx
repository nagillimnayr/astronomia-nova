...
/**
 * @description Uses the 'useFrame' hook form '@react-three/fiber' to poll the
 *   VR Controller's thumbsticks for input. It passes that input to the
 *   cameraActor state machine to pass to the camera controller.
 *
