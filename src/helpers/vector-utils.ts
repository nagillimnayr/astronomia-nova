...
/**
 * @description Returns the object's local y-axis unit vector in world coordinates.
 *
 *
...
export function getLocalUpInWorldCoords(obj: Object3D, vec?: Vector3) {
  ...
  // Get local y unit vector in world coords. (This will set _up as the object's up vector relative to the world origin. Equivalent to adding the local up vector to the object's world coords.)
